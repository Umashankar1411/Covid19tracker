...
public class GovSite extends AppCompatActivity {
    WebView webView;
    private String webUrl = "https://www.mygov.in/covid-19/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gov_site);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(GovSite.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(GovSite.this, "Downloading File..", Toast.LENGTH_SHORT).show();
